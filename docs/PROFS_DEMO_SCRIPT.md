...
down here:**
- **Candidate A — score ~92, "Highly Recommended."**
- **Candidate B — score ~68, "Consider."**
...
- Mention, if there's time: *"I also want to be transparent that the
  RAG-policy component of the fusion formula is currently a fixed
  placeholder weight, not a live per-candidate signal — that's
  documented directly in the code and is one of the limitations I
  discuss in my methodology chapter."* (This kind of unprompted
  honesty lands very well with an examiner — it shows you understand
  your own system's limits.)
...
## 2. Quick-Reference Card (print or keep on second screen)
